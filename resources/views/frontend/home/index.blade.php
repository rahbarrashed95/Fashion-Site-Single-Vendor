...
<div class="bg-gradient container-fluid" style="background: linear-gradient(120deg, #b4ffcb -20%, #1C863C 100%) !important;">
    <div class="col-12 product-header">
        <div class="section_title text-light">
           ...
           <a href="{{url('shop', $products->first()->category->slug)}}" style="color: #218A41;"> <h4 class="p-1 m-0 prodCatcus" style="text-align:center"><span style="width: auto;">{{ $products->first()->category->name }}</span></h4> </a>
            @endif
        </div>
    </div>
</div>
