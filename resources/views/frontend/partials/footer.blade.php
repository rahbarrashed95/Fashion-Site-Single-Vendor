...
<footer class="">
    ...
    <div style="background: #086e06;text-align: center;">
                <div class="row end-footer footer-end last-footer-content-align">
                    <div class="container">
                        <p class="text-left __text-16px" style="margin-bottom: 0px;padding: 4px 0px;color: #ffffff;font-size: 13px;">{{$footer->copyright}} <a style="color: #ffffff;font-size: 13px" href="https://softitglobal.com/">SoftitGlobal.com</a> </p>
                </div>
            </div>
            <!-- Grid row -->
        </div>
